...
function redraw_world(world)
{
    ...
    ctx.fillText('Penalty : ' + car.penalty, canvas_width/2, 40);
...
function createWorld() 
{
    ...
    createBox(world , 0 , 0 , 100 , 0.1 , { 'type' : b2Body.b2_staticBody , 'restitution' : 0.5 });
    createBox(world, 0, 0, 0.1, 100, { 'type' : b2Body.b2_staticBody , 'restitution' : 0.5 });
    createBox(world, 0, 6, 100, 0.1, { 'type' : b2Body.b2_staticBody , 'restitution' : 0.5 });
    createBox(world, 13.5, 0, 0.1, 100, { 'type' : b2Body.b2_staticBody , 'restitution' : 0.5 });

    createBox(world , 6.5 , 3 , 4 , 1 , { 'type' : b2Body.b2_staticBody , 'restitution' : 0.5 });
